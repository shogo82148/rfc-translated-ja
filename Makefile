...
docs/rfc9964.html: src/en/rfc9964.xml src/ja/rfc9964.xml scripts/xml2html.py data/xml2rfc-ja.css data/xml2rfc-ja.js
	scripts/xml2html.py 9964
src/en/rfc9964.xml: src/rfcs/rfc9964.xml
	cp $< $@
docs/rfc9949.html: src/en/rfc9949.xml src/ja/rfc9949.xml scripts/xml2html.py data/xml2rfc-ja.css data/xml2rfc-ja.js
	scripts/xml2html.py 9949
src/en/rfc9949.xml: src/rfcs/rfc9949.xml
	cp $< $@
docs/rfc9948.html: src/en/rfc9948.xml src/ja/rfc9948.xml scripts/xml2html.py data/xml2rfc-ja.css data/xml2rfc-ja.js
	scripts/xml2html.py 9948
src/en/rfc9948.xml: src/rfcs/rfc9948.xml
	cp $< $@
docs/rfc9651.html: src/en/rfc9651.xml src/ja/rfc9651.xml scripts/xml2html.py data/xml2rfc-ja.css data/xml2rfc-ja.js
...
src/en/rfc8725.xml: src/rfcs/rfc8725.xml
	cp $< $@
docs/rfc8610.html: src/en/rfc8610.xml src/ja/rfc8610.xml scripts/xml2html.py data/xml2rfc-ja.css data/xml2rfc-ja.js
...
docs/rfc7239.html: src/en/rfc7239.xml src/ja/rfc7239.xml scripts/xml2html.py data/xml2rfc-ja.css data/xml2rfc-ja.js
